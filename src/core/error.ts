...
export class ErrorHelper extends BaseErrorHelper {
  ...
  static emailExisted() {
    return new BaseError(403, "-104", "Email already exists.");
  }
  static emailVerified() {
    return new BaseError(403, "-104", "Email already verified.");
  }
  static addressExisted() {
    return new BaseError(403, "-104", "Address already exists.");
  }
