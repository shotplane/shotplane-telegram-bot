...
const swaggerDefinition: SwaggerDefinition = {
  ...
  info: {
    title: "Cat planet", // Title of the documentation
    version: "1.0.0", // Version of the app
    description: "Document of  Cat planet API", // short description of the app
  ...
  servers: [
    {
      url: `https://testnet-core.catplanet.io/api`,
      description: "(Development) Server",
    },
    {
      url: `http://core.catplanet.io/api`,
...
const apisSpecPath = path.join(__dirname, "/../docs/**/*.yaml");
// console.log('apisSpecPath',apisSpecPath)
